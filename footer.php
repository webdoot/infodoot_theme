    ...
    <div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
        <div class="row py-4">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="font-weight-medium"><a class="text-reset" href="<?php echo esc_html(get_bloginfo('url')) . '/about'; ?>">About</a></p>
                <p class="font-weight-medium"><a class="text-reset" href="<?php echo esc_html(get_bloginfo('url')) . '/contact'; ?>">Contact</a></p>
                <p class="font-weight-medium"><a class="text-reset" href="<?php echo esc_html(get_bloginfo('url')) . '/dmca'; ?>">DMCA</a></p>
                <p class="font-weight-medium"><a class="text-reset" href="<?php echo esc_html(get_bloginfo('url')) . '/disclaimer'; ?>">Disclaimer</a></p>
