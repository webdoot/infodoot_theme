                    ...
                    <?php
                        ...
                        if (count($post_id_arr)) {
                            foreach ($post_id_arr as $post_id) {
                                ...
                                if ($post) {
                                    $post_title = max_len($post->post_title, 45);
                    ...
                    <?php
                        ...
                        if ($random_posts) {
                            foreach ($random_posts as $random_post) {
                                $random_title = max_len($random_post->post_title, 30);
                                ...
                                echo '<img class="img-fluid w-100 h-100" src="'. get_the_post_thumbnail_url($random_post, 'full'). '" alt="' .$random_title. '" style="object-fit: cover;">';                                
                                echo '<div class="overlay">';                                
                                echo '<div class="mb-2">';
